...
namespace Application.PriceItems.PriceItemsFromCsvTaker
{
    public class PriceItemTaker : IPriceItemTaker
    {
        //Пока не доделал, потому что в example.csv есть строки, которые не парсятся, постараюсь скорее разобраться!!!
